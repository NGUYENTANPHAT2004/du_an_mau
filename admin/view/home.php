<?php $list_order_date=$cart_controller->get_order_chart();
?>
...
<main role="main">
    ...
    <div id="myfirstchart" style="height: 250px; width: 1150px; "></div>
  <script>
    new Morris.Line({
  ...
  // the chart.
  data: <?php echo json_encode($list_order_date); ?>,
  
  // The name of the data record attribute that contains x-values.
  xkey: 'year',
  // A list of names of data record attributes that contain y-values.
  ykeys: ['order_id','sale','quantily'],
