<?php
include ("/xampp/htdocs/du_an_mau/model/UserModel.php");
use PHPMailer\PHPMailer\PHPMailer;
use PHPMailer\PHPMailer\Exception;
include ("/xampp/htdocs/du_an_mau/PHPMailer/PHPMailer-master/src/Exception.php");
include ("/xampp/htdocs/du_an_mau/PHPMailer/PHPMailer-master/src/PHPMailer.php");
include ("/xampp/htdocs/du_an_mau/PHPMailer/PHPMailer-master/src/SMTP.php");
ob_start();
class UserController {
    ...
    public function register() {
        include "/xampp/htdocs/du_an_mau/client/users/register.php";
        if ($_SERVER['REQUEST_METHOD'] == 'POST') { 
            $username = $_POST['name'];
    ...
    public function login() {
        include "/xampp/htdocs/du_an_mau/client/users/login.php";
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    public function forgotPassword() {
        include "/xampp/htdocs/du_an_mau/client/users/updatepassword.php";
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    private function sendPasswordEmail($to, $password) {
        ...
        try {
            ...
            $mail->Username   = 'phat33967@gmail.com';                     //SMTP username
            $mail->Password   = 'mltfzovbskeltupx';                               //SMTP password
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
            $mail->Port       = 465;
            $mail->setFrom('phat33967@gmail.com', 'Người gửi');
            $mail->addAddress($to);
    ...
    public function  update_user(){
        include "/xampp/htdocs/du_an_mau/client/users/updateuser.php";
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            $username = $_POST['name'];
            $password = $_POST['password'];
            $date = $_POST["birthday"];
